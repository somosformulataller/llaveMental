...
// total. El peor caso es $0.50 (tras 9 fallos, con el pozo marcando
// justo $0.50). E[premio] = $1.96 exacto → RTP 98.0%.
...
export const PAYOUT_TABLE: PayoutTier[] = [
  { payout: 0.5, requiredErrors: 9, weight: 399 },
  { payout: 2.5, requiredErrors: 5, weight: 371 },
